...
int main(int argc, char **argv)
{
    ...
    const char* filename1 = "/home/xiao/ros_lab_ws/src/kalman_new/src/kalmanfileterwithrosbag/plot_E/plot_thegema_random_1_del.svg";
    plt::save(filename1);
    ...
    plt::ylim(0, 160);
    plt::pause(0.01);
    const char* filename2 = "/home/xiao/ros_lab_ws/src/kalman_new/src/kalmanfileterwithrosbag/plot_E/plot_dmaha_random_1_del.svg";
    plt::save(filename2);

    plt::figure();
    plt::plot(filted_x,filted_y,"r-",odom_x,odom_y,"k-");
    plt::pause(0.01);
    const char* filename3 = "/home/xiao/ros_lab_ws/src/kalman_new/src/kalmanfileterwithrosbag/plot_E/plot_trajectory_random_1_del.svg";
    plt::save(filename3);
