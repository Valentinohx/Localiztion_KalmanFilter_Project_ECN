	...
	int main(int argc, char **argv)
	{
	    ...
	    while (ros::ok())
	    {
	        ...
	        for (int i = 0; i < sensor_mesurements.size(); i++) //sensor_mesurements is used to store the output of measurment equation
	        {
	            ...
	            C_round_right_higher[0] = ( round(sensor_mesurements[i][0]/t_carreau) + 1 )*t_carreau;   //x higher neighboor 
	            
	            C_round_right_higher[1] = ( round(sensor_mesurements[i][1]/t_carreau) + 1 )*t_carreau;   //y right neighboor
	            
	            //left or lower line
	            VectorXd C_round_left_lower(2);
	            C_round_left_lower[0] = ( round(sensor_mesurements[i][0]/t_carreau ) - 1)*t_carreau;    // x lower neighboor 
	            
	            C_round_left_lower[1] = ( round(sensor_mesurements[i][1]/t_carreau ) - 1)*t_carreau;    // y left neighboor
	   ...
	   /* plt::subplot(3,1,1);
		...
		plt::subplot(3,1,3);
	       ...
	       //  cout<<"size  "<<dMaha_dots_index.size()<<"  "<<thegema_x.size()<<endl;
			...
			// path = " /home/valentinohx/ros/src/kalmanfileterwithrosbag/plot_results_D"
			
			
			  const char* filename1 = "/home/valentinohx/ros/src/kalmanfileterwithrosbag/plot_results_D/plot_thegema3_56.svg";
			  plt::save(filename1);
	          ...
	          plt::ylim(0, 160);
	          plt::pause(0.01);
	          const char* filename2 = "/home/valentinohx/ros/src/kalmanfileterwithrosbag/plot_results_D/plot_dmaha3_56.svg";
			  plt::save(filename2);
			  ...
			  plt::plot(filted_x,filted_y,"r-",odom_x,odom_y,"k-");
	          plt::pause(0.01);
	          const char* filename3 = "/home/valentinohx/ros/src/kalmanfileterwithrosbag/plot_results_D/plot_trajectory3_56.svg";
			  plt::save(filename3);
