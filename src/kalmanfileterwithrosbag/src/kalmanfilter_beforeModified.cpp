...
int main(int argc, char **argv)
{
  ...
  const char *filename1 = "/home/valentinohx/ros/src/kalmanfileterwithrosbag/"
                          "plot_results_D/random_long1_thegma.svg";
  plt::save(filename1);
  ...
  plt::ylim(0, 160);
  plt::pause(0.01);
  const char *filename2 = "/home/valentinohx/ros/src/kalmanfileterwithrosbag/"
                          "plot_results_D/random_long1_dmaha.svg";
  plt::save(filename2);

  plt::figure();
  plt::plot(filted_x, filted_y, "r-", odom_x, odom_y, "k-");
  plt::pause(0.01);
  const char *filename3 = "/home/valentinohx/ros/src/kalmanfileterwithrosbag/"
                          "plot_results_D/random_long1_trajectory.svg";
  plt::save(filename3);
